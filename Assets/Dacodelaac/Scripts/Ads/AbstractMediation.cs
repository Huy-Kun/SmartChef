...
namespace Dacodelaac.Ads
{
    public abstract class AbstractMediation : BaseSO
    {
        ...
        public abstract void OnAdPaid(string source, string id, double value, string network, string placement, string adFormat);
        ...
        public abstract event Action<string, string, double, string, string, string> OnBannerAdPaid;
        ...
        public abstract event Action<string, string, double, string, string, string> OnInterstitialAdPaid;
        ...
        public abstract event Action<string, string, double, string, string, string> OnRewardedAdPaid; 
