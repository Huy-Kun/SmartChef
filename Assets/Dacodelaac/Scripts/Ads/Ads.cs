...
namespace Dacodelaac.Ads
{
    ...
    {
        [SerializeField] private Event showNoInternetEvent; 
        [SerializeField] private BooleanVariable isRemovedAds;
        ...
        [SerializeField] ShortDoubleEvent watchAdsEvent;
        ...
        void AddBannerListeners()
        {
            ...
            Mediation.OnBannerAdPaid += (source, s, d, arg3, arg4, arg5) =>
                Enqueue(() => Mediation.OnAdPaid(source, s, d, arg3, arg4, arg5));
        }
        ...
        void AddRewardedListeners()
        {
            ...
            Mediation.OnRewardedAdPaid += (source, s, d, arg3, arg4, arg5) =>
                Enqueue(() => Mediation.OnAdPaid(source, s, d, arg3, arg4, arg5));
        }
        ...
        void AddInterstitialListeners()
        {
            ...
            Mediation.OnInterstitialAdPaid += (source, s, d, arg3, arg4, arg5) =>
                Enqueue(() => Mediation.OnAdPaid(source, s, d, arg3, arg4, arg5));
        }
