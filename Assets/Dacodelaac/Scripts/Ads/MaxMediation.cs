...
namespace Dacodelaac.Ads
{
    ...
    public class MaxMediation : AbstractMediation
    {
        ...
        public override void Initialize(Action onCompleted)
        {
            ...
            MaxSdkCallbacks.Rewarded.OnAdRevenuePaidEvent +=  (unit, info) => OnRewardedAdPaid?.Invoke(com.adjust.sdk.AdjustConfig.AdjustAdRevenueSourceAppLovinMAX, info.AdUnitIdentifier, info.Revenue, info.NetworkName, info.Placement, info.AdFormat);
            ...
            MaxSdkCallbacks.Interstitial.OnAdRevenuePaidEvent += (unit, info) => OnInterstitialAdPaid?.Invoke(com.adjust.sdk.AdjustConfig.AdjustAdRevenueSourceAppLovinMAX, info.AdUnitIdentifier, info.Revenue, info.NetworkName, info.Placement, info.AdFormat);
            ...
            MaxSdkCallbacks.Banner.OnAdRevenuePaidEvent += (unit, info) => OnBannerAdPaid?.Invoke(com.adjust.sdk.AdjustConfig.AdjustAdRevenueSourceAppLovinMAX, info.AdUnitIdentifier, info.Revenue, info.NetworkName, info.Placement, info.AdFormat);
        ...
        public override void OnAdPaid(string source, string unitName, double revenue, string network, string placement, string adFormat)
        {
            analyticsAdPaidEvent.Raise(new Dictionary<string, object>()
            {
                {"mediation", source}, {"revenue", revenue}, {"currency", "USD"}, {"network", network},
