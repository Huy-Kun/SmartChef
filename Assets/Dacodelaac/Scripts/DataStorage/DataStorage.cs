...
using Dacodelaac.UI.Popups.Examples;
...
namespace Dacodelaac.DataStorage
{
    public class DataStorage
    {
        ...
        public DataStorage(string name)
        {
            ...
            {
                Dacoder.LogErrorFormat("Exception deserialize {0}: {1} {2}",
        ...
        public void Save()
        {
            ...
            {
                Dacoder.LogErrorFormat("Saving {0} error {1} {2}", path,
        ...
        T To<T>(object input, T defaultValue)
        {
            ...
            if (typeof(T).IsEnum)
            {
                result = (T)Enum.ToObject(typeof(T),
                    To(input, Convert.ToInt32(defaultValue)));
            }
            else
            {
