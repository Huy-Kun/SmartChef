...
{
    public class TwoLayerButton : BaseMono, IPointerDownHandler, IPointerUpHandler
    {
        ...
        void DoOffset()
        {
            ...
            FrontRect.DOAnchorPos(targetPos, 0.15f).SetEase(ease).SetUpdate(true).SetTarget(this).Play();
        }
