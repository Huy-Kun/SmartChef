...
namespace Dacodelaac.UI.Popups
{
    ...
    public class BasePopupController : BaseMono
    {
        ...
        Canvas canvas;
        Dictionary<Type, BasePopup> popupDict;
        LinkedList<BasePopup> popups;
        ...
        public void Show<T>(bool animated,
            ShowAction showAction = ShowAction.DoNothing, object data = null)
        {
        ...
        public void Show(BasePopup basePopup, bool animated,
            ShowAction showAction = ShowAction.DoNothing, object data = null)
        {
            var t = GetTopPopup();
                ...
                switch (showAction)
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException(
                            nameof(showAction), showAction, null);
                }
            }
        ...
        public virtual void Dismiss(BasePopup basePopup, bool animated)
        {
            if (Remove(basePopup))
            {
        ...
        void AddLast(BasePopup basePopup)
        {
        ...
        bool Remove(BasePopup basePopup)
        {
            if (popups.Remove(basePopup))
            {
                Reorder();
                return true;
            }
